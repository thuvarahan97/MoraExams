...
include("assets/student.add.inc.php");
        ...
        <div class="justify-content-center align-items-center">
            <div class="col-lg-8 mx-auto" data-aos="fade-up" data-aos-delay="500">
                <form action="" method="post" class="form-box">
                    <h3 class="h4 text-black mb-4 text-center">Add New Student's Details</h3>
                    ...
                    <?php if($error_msg!="") { ?>
                        <div class="form-group">
                            ...
                            { ?>
                                <label class="control-label" style="width:100%; margin: 0 auto; text-align: center; position: relative;  float: none; color: red;">Failed to add the student's details!</label>
                            <?php
                            }
                            ?>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="name" class="form-control" placeholder="Full Name / Name with Initials" required>
                        </div>
                    </div>
                    <div class="form-group row">
                            ...
                            <select type="text" name="subject_group_id" class="form-control" required>
                                ...
                                if(mysqli_num_rows($result_subjects)>0){
                                    while($row_subjects = mysqli_fetch_assoc($result_subjects)){ ?>
                                        <option value = "<?php echo $row_subjects['subject_group_id'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select type="text" name="syllabus" class="form-control" required>
                                <option value="Common" selected>Common Syllabus</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select type="text" name="district_id_sitting" id="district_id_sitting" class="form-control" required>
                                <?php
                                if ($total_districts > 0) {
                                    while($row_districts = mysqli_fetch_assoc($result_districts)) {
                                    ?>
                                    <option
                                        value = "<?php echo $row_districts['district_id'] ?>" 
                                        <?php 
                                        if(isset($_GET['district_id']) && ($row_districts['district_id'] == $_GET['district_id'])) {
                                            echo "selected";
                                        }?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select type="text" name="centre_id" id="centre_id" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nic" maxlength="12" class="form-control" placeholder="xxxxxxxxxxxV">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" placeholder="E-mail Address">
                        </div>
                    </div>
                    <div class="form-group row">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var district_id_sitting = $("#district_id_sitting").val();
        $.ajax({
            type: "POST",
            url: "student.add.centres.fetch.php",
            data: "district_id="+district_id_sitting,
            success: function(data){
                $("#centre_id").html(data);
            }
        });

        $("#district_id_sitting").change(function(){
            district_id_sitting = $(this).val();
            $.ajax({
                type: "POST",
                url: "student.add.centres.fetch.php",
                data: "district_id="+district_id_sitting,
